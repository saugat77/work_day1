...
<div class="nav-bar-down" >
        <ul class="nav justify-content-end " style = "margin-left:740px; margin-top:-60px">
            <div class="dropdown">
...
<div class="ourwork">
        ...
        <img src="child.jpg" alt="child" style="height:300px; width:500px; float:right; padding-right:10px">
